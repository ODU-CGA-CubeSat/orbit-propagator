...
n = length(x);
time = GPS.data(1:n*60,1);
x_GPS = GPS.data(1:n*60,2:7);

x_GPS = x_GPS((mod(60*time,60) < 0.0001),:);
time = time(mod(60*time,60) < 0.0001);
